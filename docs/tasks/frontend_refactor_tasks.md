...
### `[x]` Task 3.1: 删除所有冗余和废弃的路由目录
- **状态**: `已完成`
- **依赖**: Task 1.1, Task 1.2, Task 2.1
- **目标**: 清理所有历史遗留的代码和路由，完成重构。
- **验收标准**:
    - [x] `frontend/src/app/(main)/chapters/` 目录被完全删除。
    - [x] `frontend/src/app/(main)/works/[id]/drafts/` 目录被完全删除。
    - [x] 删除操作完成后，整个应用的功能（特别是作品、章节、草稿相关功能）经过回归测试，无明显问题。