...
// GenerateOutlineRequest is the request for generating an outline.
type GenerateOutlineRequest struct {
	Text    string     `json:"text" binding:"required"`
	Context *AIContext `json:"context,omitempty"`
}

// GenerateOutlineResponse is the response for generating an outline.
type GenerateOutlineResponse struct {
	Outline string `json:"outline"`
}

// CreateCharacterRequest is the request for creating a character.
type CreateCharacterRequest struct {
	Description string     `json:"description" binding:"required"`
	Context     *AIContext `json:"context,omitempty"`
}

// CreateCharacterResponse is the response for creating a character.
