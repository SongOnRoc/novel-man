...
import (
	...
	v1 "github.com/SongOnRoc/gin-swagger/example/multiple/api/v1"
	v2 "github.com/SongOnRoc/gin-swagger/example/multiple/api/v2"
	_ "github.com/SongOnRoc/gin-swagger/example/multiple/docs"
