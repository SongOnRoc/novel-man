...
export function TreasureChest({ editor, title, workId, onOpenSearch }: TreasureChestProps) {
          ...
          {view === "main" ? (
              ...
              <div className="p-6 pt-4 grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="font-semibold">搜索工具</div>
                ...
                <Button
                  variant="outline"
                  className="h-auto flex-col items-start p-4 space-y-2 hover:bg-red-50 hover:text-red-600 hover:border-red-200 border-muted-foreground/20"
                  onClick={() => {
                    setIsOpen(false);
            ...
            <>
              <div className="flex items-center p-4 border-b">
                ...
                <DialogTitle className="text-base font-semibold">导出设置</DialogTitle>
                <DialogDescription className="sr-only">配置导出选项</DialogDescription>
              </div>
